...
def main():
    ...
    for contact in glb.allContacts:
        img = HTML.getLink(glb.allContacts[contact]["url"], _nest=f'<img src="docs/assets/Contact/{contact}" alt="{glb.allContacts[contact]["text"]}" style="width: 25%; min-width: 22px; margin: 10px; user-select:none;">')
        txt = HTML.add(f'p', _nest=HTML.getLink(glb.allContacts[contact]["url"], _nest=glb.allContacts[contact]["text"]), _style=f'width: 75%; max-width: 150px; text-align: left; margin: auto 0px;')
