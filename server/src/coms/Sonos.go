...
func (c Coms) sonos() Commands {
	return Commands{"sonos": {
		...
		Commands: Commands{
			...
			"state": {
				...
				ArgsLen:         [2]int{0, 0},
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					sts, err := c.hooks.Sonos.GetCurrentTransportState()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
			...
			"play": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if state {
							if err := c.hooks.Sonos.Play(); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						} else {
							if err := c.hooks.Sonos.Pause(); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						}
						for i := range 10 {
							sts, err := c.hooks.Sonos.GetTransitioning()
							if err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
							if sts {
					...
					state, err := c.hooks.Sonos.GetPlay()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
			...
			"mute": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if err := c.hooks.Sonos.SetMute(state); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					state, err := c.hooks.Sonos.GetMute()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.FormatBool(state)), TypeTXT, http.StatusOK, nil
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if strings.HasPrefix(args[0], "+") || strings.HasPrefix(args[0], "-") {
							volumeOld, err := c.hooks.Sonos.GetVolume()
							if err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
							if err := c.hooks.Sonos.SetVolume(volumeOld + volume); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						} else {
							if err := c.hooks.Sonos.SetVolume(volume); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						}
					}
					volume, err := c.hooks.Sonos.GetVolume()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
			...
			"seek": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					...
					if strings.HasPrefix(args[0], "+") || strings.HasPrefix(args[0], "-") {
						if err := c.hooks.Sonos.SeekTimeDelta(newIndex); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					} else {
						if err := c.hooks.Sonos.SeekTime(newIndex); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					trackInfo, err := c.hooks.Sonos.GetTrackInfo()
			...
			"position": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					...
					if strings.HasPrefix(args[0], "+") || strings.HasPrefix(args[0], "-") {
						...
						if err := c.hooks.Sonos.SeekTrack(trackInfo.QuePosition + newIndex); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					} else {
						if err := c.hooks.Sonos.SeekTrack(newIndex); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					trackInfo, err := c.hooks.Sonos.GetTrackInfo()
			...
			"next": {
				...
				ArgsLen:         [2]int{0, 0},
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if err := c.hooks.Sonos.Next(); err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					trackInfo, err := c.hooks.Sonos.GetTrackInfo()
					if err != nil {
			...
			"previous": {
				...
				ArgsLen:         [2]int{0, 0},
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if err := c.hooks.Sonos.Previous(); err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					trackInfo, err := c.hooks.Sonos.GetTrackInfo()
					if err != nil {
				...
				Commands: Commands{
					...
					"remove": {
						...
						Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
							...
							if err := c.hooks.Sonos.QueRemove(newIndex); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
							queInfo, err := c.hooks.Sonos.GetQue()
							if err != nil {
					...
					"clear": {
						...
						ArgsLen:         [2]int{0, 0},
						Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
							if err := c.hooks.Sonos.QueClear(); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
							queInfo, err := c.hooks.Sonos.GetQue()
							if err != nil {
			...
			"bass": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if strings.HasPrefix(args[0], "+") || strings.HasPrefix(args[0], "-") {
							volumeOld, err := c.hooks.Sonos.GetBass()
							if err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
							if err := c.hooks.Sonos.SetBass(volumeOld + volume); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						} else {
							if err := c.hooks.Sonos.SetBass(volume); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						}
					}
					volume, err := c.hooks.Sonos.GetBass()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.Itoa(volume)), TypeTXT, http.StatusOK, nil
			...
			"treble": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if strings.HasPrefix(args[0], "+") || strings.HasPrefix(args[0], "-") {
							volumeOld, err := c.hooks.Sonos.GetTreble()
							if err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
							if err := c.hooks.Sonos.SetTreble(volumeOld + volume); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						} else {
							if err := c.hooks.Sonos.SetTreble(volume); err != nil {
								return []byte{}, "", http.StatusBadRequest, err
							}
						}
					}
					volume, err := c.hooks.Sonos.GetTreble()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.Itoa(volume)), TypeTXT, http.StatusOK, nil
			...
			"loudness": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if err := c.hooks.Sonos.SetLoudness(state); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					state, err := c.hooks.Sonos.GetLoudness()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.FormatBool(state)), TypeTXT, http.StatusOK, nil
			...
			"led": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if err := c.hooks.Sonos.SetLED(state); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					state, err := c.hooks.Sonos.GetLED()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.FormatBool(state)), TypeTXT, http.StatusOK, nil
			...
			"playername": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 && args[0] != "" {
						if err := c.hooks.Sonos.SetZoneName(args[0]); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					curName, err := c.hooks.Sonos.GetZoneName()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
			...
			"shuffle": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if err := c.hooks.Sonos.SetShuffle(state); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					state, err := c.hooks.Sonos.GetShuffle()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.FormatBool(state)), TypeTXT, http.StatusOK, nil
			...
			"repeat": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if err := c.hooks.Sonos.SetRepeat(state); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					state, err := c.hooks.Sonos.GetRepeat()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.FormatBool(state)), TypeTXT, http.StatusOK, nil
			...
			"repeatone": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					if len(args) > 0 {
						...
						if err := c.hooks.Sonos.SetRepeatOne(state); err != nil {
							return []byte{}, "", http.StatusBadRequest, err
						}
					}
					state, err := c.hooks.Sonos.GetRepeatOne()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					return []byte(strconv.FormatBool(state)), TypeTXT, http.StatusOK, nil
			...
			"favorites": {
				...
				ArgsLen:         [2]int{0, 0},
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					favInfo, err := c.hooks.Sonos.GetSonosFavorites()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
			...
			"radioshows": {
				...
				ArgsLen:         [2]int{0, 0},
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					radInfo, err := c.hooks.Sonos.GetRadioShows()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
			...
			"radiostations": {
				...
				ArgsLen:         [2]int{0, 0},
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					radInfo, err := c.hooks.Sonos.GetRadioStations()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					jsonBytes, err := json.Marshal(radInfo)
			...
			"sync": {
				...
				Exec: func(user auth.User, args ...string) (con []byte, typ string, code int, err error) {
					...
					playing, err := c.hooks.Sonos.GetPlay()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					shuffle, repeat, _, err := c.hooks.Sonos.GetPlayMode()
					if err != nil {
						return []byte{}, "", http.StatusBadRequest, err
					}
					volume, err := c.hooks.Sonos.GetVolume()
